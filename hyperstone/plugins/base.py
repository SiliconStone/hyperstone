...
class Plugin:
    ...
    :var _INTERACT_TYPE: may be used to inform an IDE / a developer the designated interact type
    """
    ...
    def plugin_identity(self) -> List[Type]:
        ...
        :return: A list of classes / Interfaces that this plugin implements.
        """
    ...
    def prepare(self, emu: HyperEmu):
        ...
        :param emu: The instance of our emulator.
        """
        if self.ready:
            return
    ...
    def interact(self, *objs: '_INTERACT_TYPE'):
        ...
        :param objs: Objects that contain the action to be performed (usually a dataclass for this specific plugin).
        """
        if self.ready:
    ...
    def get_loaded(plugin: Type[_PLUGIN_TYPE], emu: HyperEmu) -> _PLUGIN_TYPE:
        ...
        :param plugin: Class of the plugin to find.
        :param emu: Our emulator.

        :returns: An instance of a specified plugin class.
        :raises HSPluginNotFoundError: If specified plugin class is not found.
        """
    ...
    def require(plugin: Type[_PLUGIN_TYPE], emu: HyperEmu) -> _PLUGIN_TYPE:
        ...
        :param emu: Our emulator.
        :returns: An instance of our requested plugin.
        """
        for loaded in Plugin.get_all_loaded(plugin, emu):
            return loaded
    ...
    def get_all_loaded(plugin: Type[_PLUGIN_TYPE], emu: HyperEmu) -> Iterable[_PLUGIN_TYPE]:
        ...
        :param plugin: The plugin class(es) to find.
        :param emu: Our emulator
        :returns: An iterable of all instances of specified plugin.
        """
